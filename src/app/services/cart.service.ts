...
export class CartService {
  ...
  private histoCar: Observable<Cart[]>;
  private cartCollection: AngularFirestoreCollection<Cart>;

  constructor(private firestore: AngularFirestore) {
    this.cartCollection = this.firestore.collection<Cart>('histocart');
    this.histoCar = this.cartCollection.valueChanges();
  }

  public gethistoCrt(): Observable<Cart[]> {
    return this.histoCar;
  }
  public addHistoCar(cart: Cart): Promise<String> {
